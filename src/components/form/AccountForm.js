                        ...
                        <div className="modal_centered">
                            <form id="account_form" ref={formRef} onSubmit={handleFormSubmit}>
                                ...
                                <div className="form_head">
                                    <h2>{isSignupVisible ? 'Cadastrar' : 'Login'}</h2>
                                    <p>
                                        {isSignupVisible ? 'Ja tem uma conta?' : 'Novo por aqui?'}
                                        &nbsp;&nbsp;
                                        <button type="button" onClick={handleIsSignupVisible}>
                                            {isSignupVisible ? 'Login' : 'Criar uma conta'}
                                        </button>
                                    </p>
                                </div>
                                ...
                                <div className="form_body">
                                    ...
                                    >
                                        {isSignupVisible ? 'Cadastrar' : 'Login'}
                                    </button>
